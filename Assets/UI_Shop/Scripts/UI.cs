...
public class UI : MonoBehaviour
{
    ...
    private void GenerateIngredientFromData()
    {
        ...
        int indexPage = 0;
        int maxPage = (int)(listData.Count / 9);
    ...
    private bool CanUnlock()
    {
        ...
        for (int i = 0; i < listData.Count; i++)
        {
            ...
            if (nameItem == "skin")
            {
                ...
                i == 6 || i == 8 || i == 9)
                {
                    _isSameAutoUnlock = true;
                }
            }
            else if (nameItem == "block")
            {
                if (i == 5 || i == 6 || i == 7)
                {
                    _isSameAutoUnlock = true;
            ...
            if (GetIngredientNumber(i) == 1 || _isSameAutoUnlock)
            {
                n++;
            }
        }
    ...
    private void UnlockIngredient()
    {
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            if (nameItem == "skin")
            {
                if (randomValue == 2 || randomValue == 3 || randomValue == 5 ||
              randomValue == 6 || randomValue == 8 || randomValue == 9)
                {
                    _isSameAutoUnlock = true;
                }
            }
            ...
            {
                if (randomValue == 5 || randomValue == 6 || randomValue == 7)
                {
                    _isSameAutoUnlock = true;
                }
            }
            ...
            if (GetIngredientNumber(randomValue) == 1 || _isSameAutoUnlock)
            {
                randomValue = Random.Range(0, listData.Count);
                i--;
    ...
    {
        Debug.Log(nameItem + " select " + number);
        ...
        if(nameItem == "skin")
        {
            CurrentSkinPlayer = number;
            headerImage.sprite = listData[CurrentSkinPlayer];
            GameManager.Instance.canonDiceGame.UpdateTurretPlayer(CurrentSkinPlayer);
            //  GameManager.Instance.UpdateBallSkin(number);
        }
        else if (nameItem == "block")
        {
            // 524316
            CurrentSkinPlayer = number;
            GameManager.Instance.canonDiceGame.UpdateBlockSkin(CurrentSkinPlayer);
          //  DataManager.Instance.CurrentSkill = number;
        }
        else
        {
          //  GameManager.Instance.main.ChangeSkinPlayer(number);
        }
